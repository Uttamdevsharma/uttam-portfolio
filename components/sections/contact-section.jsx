      ...
      <div className="container mx-auto px-4">
            ...
            <div className="space-y-6">
              <div className="flex items-center space-x-4">
                ...
                <div>
                  ...
                  <p className={`${isDarkMode ? "text-gray-300" : "text-gray-600"}`}>uttam@example.com</p>
                </div>
              </div>
              ...
              <div className="flex items-center space-x-4">
                ...
                <div>
                  ...
                  <p className={`${isDarkMode ? "text-gray-300" : "text-gray-600"}`}>San Francisco, CA</p>
                </div>
              </div>
            </div>
        ...
        <div className={`mt-20 pt-8 border-t ${isDarkMode ? "border-gray-700" : "border-gray-300"} text-center`}>
          <p className={`${isDarkMode ? "text-gray-400" : "text-gray-600"}`}>
            © 2024 Uttam. All rights reserved. Built with React and Tailwind CSS.
          </p>
        </div>
      </div>
    </section>
