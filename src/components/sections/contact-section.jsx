  ...
  return (
    <section className={`py-20 ${isDarkMode ? "bg-[#171d29]" : "bg-gray-50"}`}>
      <div className="container mx-auto">
        ...
        <div className="max-w-6xl mx-auto grid lg:grid-cols-2 gap-12">
          ...
          <div className="space-y-8">
            <div>
              ...
              <p className={`text-lg mb-8 ${isDarkMode ? "text-gray-300" : "text-gray-600"} leading-relaxed`}>
            ...
            <div className="space-y-6">
              <div className="flex items-center space-x-4">
                ...
                <div>
                  ...
                  <p className={`${isDarkMode ? "text-gray-300" : "text-gray-600"}`}>uttamrohit4545@example.com</p>
                </div>
              </div>
              ...
              <div className="flex items-center space-x-4">
                ...
                <div>
                  ...
                  <p className={`${isDarkMode ? "text-gray-300" : "text-gray-600"}`}>+8801701560326</p>
                </div>
              </div>
              ...
              <div className="flex items-center space-x-4">
                ...
                <div>
                  ...
                  <p className={`${isDarkMode ? "text-gray-300" : "text-gray-600"}`}>Narayanganj, Dhaka-1461</p>
                </div>
              </div>
            </div>
            ...
            {/* Social Links */}
            <div className="pt-8">
              <h4 className={`font-semibold mb-4 ${isDarkMode ? "text-white" : "text-gray-900"}`}>Follow Me</h4>
          ...
          {/* Contact Form */}
          <div className={`p-8 rounded-xl ${isDarkMode ? "bg-gray-800/50" : "bg-white"} backdrop-blur-sm`}>
        ...
        {/* Footer */}
        <div className={`mt-20 pt-8 border-t ${isDarkMode ? "border-gray-700" : "border-gray-300"} text-center`}>
          <p className={`${isDarkMode ? "text-gray-400" : "text-gray-600"}`}>
            © 2025 Uttam. All rights reserved. 
          </p>
        </div>
      </div>
    </section>
